...
dictionary = {
    ...
    "en_US": {
        ...
        "类型: ": "Type: ",
        "属性节点:": "Attribute Node:",
        "存储属性节点:": "Store Named Attribute Node:",
        "属性所在域: ": "Attribute Domain: ",
        "所在节点组: ": "In Which Groups: ",
        "属性隐藏选项": "Attribute Hide Options",
        "命名属性菜单": "Named Attribute List Menu",
        "命名属性面板": "Named Attribute List Panel",
        "几何节点命名属性列表": "Geometry Nodes Named Attribute List",
        "快速添加命名属性节点": "Quickly Add Named Attribute Node",
        "小王-命名属性菜单": "Named Attribute List Menu",
        "小王-命名属性面板": "Named Attribute List Panel",
        ...
        "todo-隐藏没连到组输出的存储属性节点的属性": "todo-Hide Attribute of Store Named Attribute Node of output Unlinked to Group Output",
        ...
        "是否在属性列表里隐藏顶点组": "Hide Vertex Groups in Attribute List",
        "是否在属性列表里隐藏UV贴图": "Hide UV Maps in Attribute List",
        "是否在属性列表里隐藏颜色属性": "Hide Color Attributes in Attribute List",
        ...
        "跳过输出未连线的节点组\n(仅判断节点组输出是否连线,不追踪完整链路)": "Skip node groups with unlinked output\n(only checks if node group output is linked, does not trace full chain)",
        "节点组内属性的显示方式": "Display mode for attributes inside node groups",
        "子菜单": "SubGroup",
        "平铺": "Flat",
        "默认": "Default",
