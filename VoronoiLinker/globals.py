...
dict_vmtMixerNodesDefs = { # '-1' 表示这里的视觉标记，它们的连接套接字是自动计算的（参见 |2|），而不是在此列表中明确指定
        ...
        'GeometryNodeSwitch':             (-1, -1, 'A Switch'),
        ...
        'GeometryNodeIndexSwitch':        (1, 2, 'S Index Switch'),
        'GeometryNodeMenuSwitch':         (1, 2, 'D Menu Switch'),
        'ShaderNodeCombineXYZ':           (0, 1, 'Combine XYZ'),
        # 字符串接口 Alt Shift 左键
        'GeometryNodeStringJoin':         (1, 1, 'Q Join String'),
        ...
        'GeometryNodeGeometryToInstance': (0, 0, 'R To Instance'),
