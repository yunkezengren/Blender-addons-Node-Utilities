...
def add_left_prop(layout: UILayout, who, att, active=True):
...
def add_none_box(layout: UILayout):
    box = layout.box()
    box.label()
    box.scale_y = 0.5
...
def add_nice_color_prop(layout: UILayout, who, att, align=False, txt="", ico='NONE', decor=3):
...
def add_thin_sep(layout: UILayout, scaleY):
